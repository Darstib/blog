...
- [CTF](CTF/README.md)
    ...
    - NOTE
        ...
        - MISC
            - [audio](CTF/NOTE/MISC/audio.md)
            - [Flow_analysis](CTF/NOTE/MISC/Flow_analysis.md)
            - [img](CTF/NOTE/MISC/img.md)
            - [info_leak](CTF/NOTE/MISC/info_leak.md)
            - [pyjail](CTF/NOTE/MISC/pyjail.md)
            - [qrcode](CTF/NOTE/MISC/qrcode.md)
            - [zip_rar](CTF/NOTE/MISC/zip_rar.md)
        - other
...
- [Note](note/README.md)
    - [cs188](note/cs188/README.md)
        - [note](note/cs188/note/README.md)
            ...
            - [11-Bayesian_Network_Intro](note/cs188/note/11-Bayesian_Network_Intro.md)
            - [12-Variable_Elimination](note/cs188/note/12-Variable_Elimination.md)
            - [13-Approximate_Inference](note/cs188/note/13-Approximate_Inference.md)
            - [14-Markov_Models](note/cs188/note/14-Markov_Models.md)
            - [15-Hidden_Marko_Models](note/cs188/note/15-Hidden_Marko_Models.md)
            - [16-PF-DN-VPI](note/cs188/note/16-PF-DN-VPI.md)
            - [17-Markov_Decision_Processes](note/cs188/note/17-Markov_Decision_Processes.md)
            - [18-Iteration](note/cs188/note/18-Iteration.md)
            - [19-Navie_Bayes](note/cs188/note/19-Navie_Bayes.md)
            - [20-Perceptron](note/cs188/note/20-Perceptron.md)
            - [21-Regression](note/cs188/note/21-Regression.md)
            - [22-Neural_Networks](note/cs188/note/22-Neural_Networks.md)
            - [24-Reinforcement_Learnin](note/cs188/note/24-Reinforcement_Learnin.md)
